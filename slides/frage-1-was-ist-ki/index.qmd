...
::: {.key-point}
## Statistik, nicht Verstehen

Sprachmodelle **verstehen** nicht.

Sie berechnen statistische Wahrscheinlichkeiten basierend auf Mustern in den Trainingsdaten.
:::
...
## "Denken" ist auch Statistik

::: {.key-point}
## Keine echte Kognition

"Denken" verbessert die Ergebnisse, aber es ist kein menschliches Denken.

Es ist eine Technik, die bessere Token-Vorhersagen ermöglicht, weil mehr Kontext (die Zwischenschritte) zur Verfügung steht.
:::
...
| Aspekt | Realität |
|--------|----------|
| Textgenerierung | Statistische Vorhersage des nächsten Worts |
| "Verstehen" | Mustererkennung, kein echtes Verstehen |
| "Denken" | Mehr Tokens = bessere Vorhersagen |
| Wissen | Muster aus Trainingsdaten, keine Faktendatenbank |
