...
::: {.column width="50%"}
:::{.r-fit-text}
- LLMs werden trainiert, **plausibel klingende** Texte zu generieren, nicht faktisch korrekte.
- Das bedeutet: Alle Aussagen kritisch hinterfragen.
...
Sprachmodelle generieren Text Wort für Wort, ohne eingebaute Faktenprüfung.
